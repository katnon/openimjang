            ...
            <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden">
                                    ...
                                    <div className="flex items-start justify-between">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {memo.aptName && (
                                                        <div className="flex items-center gap-1 mb-2">
                                                            ...
                                                            <span className="text-sm text-primary-600 font-medium">{memo.aptName}</span>
                                                        </div>
                                                    )}
                                                    {memo.body && (
                                        ...
                                        <div className="flex gap-1">
                                            ...
                                            <button
                                                ...
                                                className="p-2 text-gray-400 hover:text-secondary-500 hover:bg-secondary-50 rounded transition-colors"
                                                title="메모 수정"
                                            >
                ...
                <div className="border-t p-6">
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            onClick={onClose}
                            className="px-4 py-2 bg-secondary-700 text-white rounded-lg hover:bg-secondary-800 transition-colors"
                        >
                            닫기
                        </button>
                    </div>
